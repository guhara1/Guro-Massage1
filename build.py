...
PAGES.append({
    ...
    "blocks": [
        ...
        ("h2", "신도림·구로디지털단지·개봉·오류 생활권 차이"),
        ("p", "구로구 홈타이를 안내할 때 가장 중요한 부분은 행정동을 무리하게 쪼개지 않는 것입니다. 구로1동부터 구로5동까지를 각각 개별 페이지로 만들면 본문이 비슷해질 위험이 큽니다. 그래서 바로GO는 구로동 대표 페이지로 통합하고, 그 안에서 구로역·남구로역·구로디지털단지역·구로구청 인근 생활권을 나눠 설명합니다. 신도림은 환승 교통권, 구로디지털단지는 업무지구, 고척·개봉은 주거권, 오류·수궁·항동은 서남부 주거권으로 검색 의도가 서로 다릅니다."),
        ...
        ("p", "역세권 페이지는 실제 검색 수요가 생길 수 있는 역명 기준으로 1개 URL만 운영합니다. 신도림역·온수역처럼 환승역은 노선별로 쪼개지 않고, 가산디지털단지역은 금천구 성격이 강해 구로구 단독 페이지로 만들지 않습니다. 대림역은 구로·영등포 경계 성격이 있어 구로동 본문에서 인접 생활권으로도 함께 설명합니다."),
        ("cards", [
        ...
        ("h2", "구글 가이드라인에 맞춘 구로구 페이지 운영 기준"),
        ("p", "바로GO는 검색엔진을 속이기 위한 도어웨이 페이지를 만들지 않습니다. 번호 행정동(구로1~5동, 고척1·2동, 개봉1~3동, 오류1·2동)은 개별 페이지로 만들지 않고 대표동으로 통합하며, 같은 본문에서 지역명만 바꾸는 방식도 사용하지 않습니다. 각 페이지는 해당 지역의 생활권·이동 기준·예약 정보를 고유하게 담아, 사용자에게 실제로 도움이 되는 정보형 안내를 제공합니다."),
        ("check", [
            "번호 행정동은 대표동으로 통합 (구로동·고척동·개봉동·오류동)",
            "환승역은 노선별로 쪼개지 않고 역명 기준 1개 URL",
            "허위 후기·가짜 체험담·과도한 할인 문구 미사용",
            "불법·선정적 표현 미사용, 합법적 방문형 관리 서비스만 안내",
            "방문 지역·이동비·결제·취소·개인정보 기준을 명확히 공개",
        ]),

        ("h2", "구로구 출장마사지 사이트 이용 방법"),
        ("p", "먼저 상단 메뉴에서 현재 위치와 가까운 대표 행정동 또는 역세권을 선택해 방문 가능 지역과 이동 기준을 확인하세요. 이후 예약 안내 페이지에서 예약 가능 시간과 결제·취소 기준을 확인한 뒤, 전화로 정확한 위치를 알려주시면 됩니다. 홈타이가 처음이라면 홈타이 이용 가이드에서 출장마사지와의 차이, 이용 전 준비 사항을 먼저 살펴보시길 권합니다."),
        ("cards", [
...
PAGES.append(content_page(
    ...
    [
        ...
        ("p", "신도림동은 1·2호선 신도림역을 중심으로 환승 수요가 매우 큰 지역입니다. 디큐브시티와 현대백화점, 테크노마트로 이어지는 상업권과 도림천 인접 주거권이 함께 있어, 같은 신도림동이라도 위치에 따라 이동 동선이 달라집니다. 바로GO는 신도림동을 단독 페이지로 운영하면서 신도림역·도림천역 생활권을 함께 안내합니다."),
        ("p", "신도림역은 환승 수요가 크기 때문에 역세권 페이지를 따로 두지만, 1호선·2호선처럼 노선별로 페이지를 쪼개지는 않습니다. 역명 기준 하나의 안내로 충분히 동선을 설명할 수 있기 때문입니다."),
    ],
    [
        ("h2", "신도림동 주요 생활권"),
        ("check", [
...
PAGES.append(content_page(
    ...
    "구로동 · 대표 행정동",
    "구로1동부터 구로5동까지를 하나로 묶은 구로동 대표 안내입니다. 구로역·남구로역·구로디지털단지역·구로구청 인근 생활권을 나눠 방문 기준을 설명합니다.",
    [DIST_CRUMB, ("구로동 출장마사지", None)],
    ["구로동 출장마사지","구로 출장마사지","구로 홈타이","구로역 출장마사지","남구로역 출장마사지","구로디지털단지 출장마사지"],
    "구로동",
    [
        ("h2", "구로동은 왜 하나의 대표 페이지로 안내하나요"),
        ("p", "구로동은 행정동상 구로1동부터 구로5동까지 나뉘지만, 바로GO는 이를 개별 페이지로 만들지 않고 구로동 대표 페이지 하나로 통합합니다. 번호 동을 각각 만들면 본문이 비슷해져 도어웨이 페이지처럼 보일 위험이 크기 때문입니다. 대신 구로동 안에서 구로역, 남구로역, 구로디지털단지역, 구로구청 인근 생활권을 나눠 설명합니다."),
        ("p", "구로동은 업무지구와 주거지가 함께 있는 지역입니다. 구로디지털단지는 업무지구 검색 의도가 강하고, 남구로역 주변은 주거지와 상권이 함께 있습니다. 그래서 구로동 페이지는 구 전체 생활권을 넓게 안내하고, 구로디지털단지역 페이지는 역 주변 업무권과 이동 기준을 중심으로 다르게 다룹니다."),
    ],
    [
        ("h2", "구로동 주요 생활권"),
        ("check", [
        ...
        ("p", "대림역은 구로·영등포 경계 성격이 있어 구로동 본문에서 인접 생활권으로 함께 설명합니다. 구로디지털단지역은 구로 업무지구 검색 의도가 뚜렷해 별도 역세권 페이지로도 안내합니다."),
    ],
    [("구로역 출장마사지","/seoul/guro/guro-station-chuljangmassage/"),
     ("남구로역 출장마사지","/seoul/guro/namguro-station-chuljangmassage/"),
     ("구로디지털단지역 출장마사지","/seoul/guro/guro-digital-complex-station-chuljangmassage/"),
     ...
     ("예약 안내","/seoul/guro/reservation/")],
    [("구로1동, 구로2동도 방문하나요?","네. 구로1동부터 구로5동까지 모두 구로동 대표 페이지에서 안내하며 전 지역 방문이 가능합니다. 정확한 위치를 알려주시면 동선을 안내합니다."),
...
PAGES.append(content_page(
    ...
    [
        ("h2", "가리봉동 방문 가능 지역"),
        ("p", "가리봉동은 남구로역과 가산디지털단지역 인접권, 구로디지털단지 주변 생활권과 연결되는 지역입니다. 주거지와 상권, 업무지구가 가까이 있어 자택·숙소·사무실 인근 방문 문의가 고르게 들어옵니다. 바로GO는 가리봉동을 단독 페이지로 운영하면서 남구로 생활권과 함께 안내합니다."),
        ("p", "다만 가산디지털단지역은 행정구역상 금천구 성격이 강하므로, 구로구 사이트에서는 가리봉동 본문 안에서 인접 생활권으로만 설명합니다. 가산디지털단지역 단독 역세권 페이지는 별도로 만들지 않습니다."),
    ],
    [
        ("h2", "가리봉동 주요 생활권"),
        ("check", [
...
PAGES.append(content_page(
    ...
    "고척동 · 대표 행정동",
    "고척1동·고척2동을 하나로 묶은 고척동 대표 안내입니다. 고척스카이돔, 구일역, 안양천 인근 주거 생활권 방문 기준을 설명합니다.",
    [DIST_CRUMB, ("고척동 출장마사지", None)],
    ["고척동 출장마사지","고척 출장마사지","고척 홈타이","구일역 출장마사지","고척스카이돔 출장마사지"],
    "고척동",
    [
        ("h2", "고척동은 주거 생활권 중심입니다"),
        ("p", "고척동은 고척1동과 고척2동으로 나뉘지만 바로GO는 고척동 대표 페이지 하나로 통합해 안내합니다. 고척스카이돔, 구일역, 안양천 인근으로 이어지는 주거 생활권이 중심이라 신도림이나 구로디지털단지와는 검색 의도가 다릅니다. 그래서 상권 문구를 반복하지 않고 주거지 방문 기준과 고척스카이돔 인근 이동 기준을 중심으로 설명합니다."),
    ],
    [
        ("h2", "고척동 주요 생활권"),
        ("check", [
...
PAGES.append(content_page(
    ...
    "개봉동 · 대표 행정동",
    "개봉1동·개봉2동·개봉3동을 하나로 묶은 개봉동 대표 안내입니다. 개봉역, 개봉시장, 구로 서부 주거권 방문 기준을 설명합니다.",
    [DIST_CRUMB, ("개봉동 출장마사지", None)],
    ["개봉동 출장마사지","개봉 출장마사지","개봉 홈타이","개봉역 출장마사지"],
    "개봉동",
    [
        ("h2", "개봉동은 대표동 하나로 통합 안내합니다"),
        ("p", "개봉동은 개봉1동, 개봉2동, 개봉3동으로 나뉘지만 각각 만들지 않고 개봉동 대표 페이지 안에서 세부 생활권을 나눠 설명합니다. 개봉역과 개봉시장을 중심으로 한 구로 서부 주거권이 핵심 생활권입니다. 개봉역 페이지는 역 주변 이동 기준을 담당하고, 개봉동 페이지는 주거지와 생활권 안내를 담당해 중복을 줄였습니다."),
    ],
    [
        ("h2", "개봉동 주요 생활권"),
        ("check", [
    ...
    [("개봉역 출장마사지","/seoul/guro/gaebong-station-chuljangmassage/"),
     ...
     ("오류동 출장마사지","/seoul/guro/oryu-dong-chuljangmassage/"),
     ("예약 안내","/seoul/guro/reservation/")],
    [("개봉1동, 개봉3동도 방문하나요?","네. 개봉1~3동 모두 개봉동 대표 페이지에서 안내하며 전 지역 방문이 가능합니다.")],
))
...
PAGES.append(content_page(
    ...
    "오류동 · 대표 행정동",
    "오류1동·오류2동을 하나로 묶은 오류동 대표 안내입니다. 오류동역과 천왕역, 천왕동 인접 생활권 방문 기준을 설명합니다.",
    [DIST_CRUMB, ("오류동 출장마사지", None)],
    ["오류동 출장마사지","오류 출장마사지","오류 홈타이","오류동역 출장마사지","천왕역 출장마사지"],
    "오류동",
    [
        ("h2", "오류동과 서남부 생활권"),
        ("p", "오류동은 오류1동과 오류2동으로 나뉘지만 바로GO는 오류동 대표 페이지 하나로 통합해 안내합니다. 오류동역과 천왕역, 천왕동 인접 생활권을 중심으로 구성하며, 천왕동은 오류동·천왕 생활권 페이지에서 보조로 다룹니다. 구로구 서남부는 신도림·구로디지털단지보다 차량 이동 시간이 달라질 수 있어 지역별 이동 기준을 분명히 안내합니다."),
    ],
    [
        ("h2", "오류동 주요 생활권"),
        ("check", [
...
PAGES.append(content_page(
    ...
    "수궁동 · 대표 행정동",
    "수궁동 대표 페이지에서 궁동과 온수동 법정동 생활권을 함께 안내합니다. 온수역 환승권과 주거 생활권 방문 기준을 설명합니다.",
    [DIST_CRUMB, ("수궁동 출장마사지", None)],
    ["수궁동 출장마사지","온수동 출장마사지","궁동 출장마사지","온수역 출장마사지","수궁동 홈타이"],
    "수궁동",
    [
        ("h2", "수궁동은 궁동·온수동을 함께 안내합니다"),
        ("p", "수궁동은 행정동으로, 법정동인 궁동과 온수동을 포함합니다. 바로GO는 수궁동 대표 페이지에서 궁동과 온수동 생활권을 함께 설명하고, 온수역 환승권은 온수역 페이지와 온수역·수궁동 생활권 페이지에서 보조로 안내합니다. 1·7호선 온수역을 중심으로 한 환승권과 조용한 주거권이 함께 있는 지역입니다."),
    ],
    [
        ("h2", "수궁동 주요 생활권"),
        ("check", [
    ...
    [("온수역 출장마사지","/seoul/guro/onsu-station-chuljangmassage/"),
     ...
     ("항동 출장마사지","/seoul/guro/hang-dong-chuljangmassage/"),
     ("개인정보 처리방침","/seoul/guro/privacy/")],
    [("궁동과 온수동도 방문하나요?","네. 궁동과 온수동은 수궁동 대표 페이지에서 함께 안내하며 방문이 가능합니다.")],
))
...
PAGES.append(content_page(
    ...
    [
        ("h2", "항동 주거지 방문 안내"),
        ("p", "항동은 항동지구 신규 주거단지와 푸른수목원 인근 생활권이 중심인 구로구 서남부 지역입니다. 신도림·구로디지털단지처럼 도심 교통권과는 거리가 있어 차량 이동 시간이 더 걸릴 수 있습니다. 바로GO는 항동을 단독 페이지로 운영하면서 항동 주거지 생활권의 이동 기준을 명확히 안내합니다."),
    ],
    [
        ("h2", "항동 주요 생활권"),
        ("check", [
...
PAGES.append(content_page(
    ...
    "온수동 생활권 출장마사지 안내",
    "온수동 · 생활권 보조 안내",
    "온수동은 수궁동 대표 페이지와 온수역 환승권으로 함께 안내하는 법정동입니다. 온수역 인근 주거·환승 생활권 방문 기준을 설명합니다.",
    [AREA_CRUMB, ("온수동 생활권", None)],
    ["온수동 출장마사지","온수역 출장마사지","온수 홈타이"],
    "온수동",
    [
        ("h2", "온수동은 수궁동·온수역과 함께 안내합니다"),
        ("p", "온수동은 수궁동에 속한 법정동으로, 바로GO는 온수동을 수궁동 대표 페이지와 온수역 생활권에서 함께 안내합니다. 1·7호선 온수역 환승권과 부천 경계 인접 주거권이 함께 있어, 숙소·사무실 인근과 자택 방문 문의가 고르게 들어옵니다."),
    ],
    [
        ("h2", "온수동 주요 생활권"),
        ("check", [
...
PAGES.append(content_page(
    ...
    "궁동 생활권 출장마사지 안내",
    "궁동 · 생활권 보조 안내",
    "궁동은 수궁동 대표 페이지에서 함께 안내하는 법정동입니다. 궁동 근린공원 인근 조용한 주거 생활권 방문 기준을 설명합니다.",
    [AREA_CRUMB, ("궁동 생활권", None)],
    ["궁동 출장마사지","궁동 홈타이","수궁동 출장마사지"],
    "궁동",
    [
        ("h2", "궁동은 수궁동 생활권으로 안내합니다"),
        ("p", "궁동은 수궁동에 속한 법정동으로, 바로GO는 궁동을 수궁동 대표 페이지의 생활권으로 함께 안내합니다. 궁동저수지·궁동근린공원 인근의 조용한 주거권이 특징이며, 자택 방문 문의가 많은 지역입니다. 온수역 환승권과도 가까워 이동 동선을 함께 안내합니다."),
    ],
    [
        ("h2", "궁동 주요 생활권"),
        ("check", [
...
PAGES.append(content_page(
    ...
    [
        ...
        ("p", "신도림역은 1호선과 2호선이 만나는 환승역으로, 디큐브시티와 호텔·오피스텔이 밀집해 숙소·사무실 인근 방문 문의가 많습니다. 바로GO는 환승역이라도 1호선 페이지와 2호선 페이지를 따로 만들지 않고, 신도림역 하나의 안내로 동선을 설명합니다. 역명 기준 1개 URL만 운영해 중복 콘텐츠 위험을 줄였습니다."),
    ],
    [
        ("h2", "신도림역 인근 방문 포인트"),
        ("check", [
...
PAGES.append(content_page(
    ...
    "구로역 · 역세권 안내",
    "1호선 구로역 인근 주거·상업 혼합 생활권 방문 기준을 안내합니다. 구로동 대표 페이지와 함께 보시면 동선 파악에 도움이 됩니다.",
    [STN_CRUMB, ("구로역 출장마사지", None)],
    ["구로역 출장마사지","구로 출장마사지","구로역 홈타이"],
    "구로역",
    [
        ("h2", "구로역 인근 방문 안내"),
        ("p", "구로역은 1호선 주요 역으로 신도림 방향 환승 동선과 가깝고, AK플라자 인근 상업권과 주거권이 함께 있습니다. 구로역 인근은 구로동 생활권의 일부로, 보다 넓은 구로동 안내는 구로동 대표 페이지에서 확인하실 수 있습니다."),
    ],
    [
        ("h2", "구로역 인근 방문 포인트"),
        ("check", [
...
PAGES.append(content_page(
    ...
    "개봉역 · 역세권 안내",
    "1호선 개봉역과 개봉시장 중심 주거권 방문 기준을 안내합니다. 개봉동 대표 페이지와 함께 보시면 좋습니다.",
    [STN_CRUMB, ("개봉역 출장마사지", None)],
    ["개봉역 출장마사지","개봉동 출장마사지","개봉역 홈타이"],
    "개봉역",
    [
        ("h2", "개봉역 인근 방문 안내"),
        ("p", "개봉역은 1호선 역으로 개봉시장과 구로 서부 주거권의 중심에 있습니다. 개봉역 페이지는 역 주변 이동 기준을 담당하고, 주거지와 세부 생활권 안내는 개봉동 대표 페이지에서 다루어 중복을 줄였습니다."),
    ],
    [
        ("h2", "개봉역 인근 방문 포인트"),
        ("check", [
...
PAGES.append(content_page(
    ...
    [
        ("h2", "온수역 환승권 방문 안내"),
        ("p", "온수역은 1호선과 7호선이 만나는 환승역으로, 수궁동·온수동·궁동 생활권의 관문 역할을 합니다. 바로GO는 환승역이라도 노선별로 페이지를 쪼개지 않고 온수역 하나의 안내로 운영합니다. 부천 경계와 가까워 위치에 따라 이동 시간이 달라질 수 있습니다."),
    ],
    [
        ("h2", "온수역 인근 방문 포인트"),
        ("check", [
    ...
    [("수궁동 출장마사지","/seoul/guro/sugung-dong-chuljangmassage/"),
     ...
     ("예약 안내","/seoul/guro/reservation/")],
    [("온수역은 노선별로 페이지가 다른가요?","아니요. 온수역은 1·7호선을 합쳐 하나의 페이지로 안내합니다. 환승역도 역명 기준 1개 URL만 운영합니다.")],
))
...
PAGES.append(content_page(
    ...
    [
        ...
        ("p", "대림역은 2·7호선 환승역으로 구로구와 영등포구의 경계에 있습니다. 구로구 사이트에서는 대림역을 구로동 인접 생활권 중심으로 안내하며, 영등포 방향 위치는 전화로 확인 후 방문 가능 여부를 안내해 드립니다."),
    ],
    [
        ("h2", "대림역 인근 방문 포인트"),
        ("check", [
...
PAGES.append(content_page(
    ...
    "구로디지털단지역 · 역세권 안내",
    "2호선 구로디지털단지역 업무지구 방문 기준을 안내합니다. 사무실 인근 방문 검색 의도가 뚜렷해 별도 페이지로 운영합니다.",
    [STN_CRUMB, ("구로디지털단지역 출장마사지", None)],
    ["구로디지털단지역 출장마사지","구로디지털단지 출장마사지","구로디지털 홈타이"],
    "구로디지털단지역",
    [
        ("h2", "구로디지털단지역 업무지구 방문 안내"),
        ("p", "구로디지털단지역은 2호선 역으로 IT·벤처 기업이 밀집한 구로 업무지구의 중심입니다. 업무지구 검색 의도가 뚜렷해 바로GO는 별도 역세권 페이지로 운영하며, 구로동 대표 페이지와는 다르게 사무실 인근 방문과 이동 기준을 중심으로 안내합니다."),
    ],
    [
...
PAGES.append(content_page(
    ...
    [
        ("h2", "도림천역 인근 방문 안내"),
        ("p", "도림천역은 2호선 신정지선 역으로 신도림동 도림천 인접 주거권에 있습니다. 신도림역 상업권과 가까우면서도 조용한 주거권이라 자택 방문 문의가 많습니다. 신도림동 대표 페이지와 함께 보시면 생활권 파악에 도움이 됩니다."),
    ],
    [
        ("h2", "도림천역 인근 방문 포인트"),
        ("check", [
...
PAGES.append(content_page(
    ...
    [
        ("h2", "신도림 생활권 전반 안내"),
        ("p", "신도림 생활권은 신도림역 환승권을 중심으로 디큐브시티, 현대백화점, 테크노마트, 도림천 주거권까지 폭넓게 이어집니다. 역세권 페이지가 역 진입 동선을 다룬다면, 이 생활권 페이지는 신도림 일대 전체의 방문 동선과 이용 흐름을 넓게 안내합니다."),
    ],
    [
        ("h2", "신도림 생활권 구성"),
        ("check", [
...
PAGES.append(content_page(
    ...
    [
        ...
        ("p", "구로디지털단지 생활권은 IT·벤처 업무지구와 마리오아울렛 상업권, 인접 구로동 주거권이 함께 어우러진 지역입니다. 사무실 인근 방문 검색 의도가 강한 만큼, 업무지구의 이동 동선과 주거권 방문 기준을 함께 안내합니다."),
    ],
    [
        ("h2", "구로디지털단지 생활권 구성"),
        ("check", [
...
PAGES.append(content_page(
    ...
    [
        ("h2", "개봉역 생활권 전반 안내"),
        ("p", "개봉역 생활권은 개봉시장과 개봉1~3동 주거권을 아우르는 구로 서부 생활권입니다. 역세권 페이지가 역 진입 동선을 다룬다면, 이 생활권 페이지는 개봉 일대 주거권의 방문 흐름을 넓게 안내합니다."),
    ],
    [
        ("h2", "개봉역 생활권 구성"),
        ("check", [
